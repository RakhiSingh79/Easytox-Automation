...
public class VerifyDisablingAccessLabUserSteps {
	private WebDriver driver;
	private WebElementHelper webElementHelper;
	private String user = "cgilabadmin";
	
	public VerifyDisablingAccessLabUserSteps() {
	...
	@When("^Click \"([^\"]*)\" icon for any existing user under Enable/Disable column$")
	public void click_icon_for_any_existing_user_under_Enable_Disable_column(String arg1) throws Throwable {
	...
	public void user_should_be_disabled_and_message_should_be_populated(String arg1) throws Throwable {
