...
public class VerifyThePaginationSteps {
	...
	@Given("^Usern should be login to user$")
	public void usern_should_be_login_to_user() throws Throwable {
	...
	public void user_should_be_navigate_to_the_selected_page() throws Throwable {
		if(driver.findElements(By.cssSelector(".active")).size() > 5) {
			Assert.assertEquals(Integer.parseInt(driver.findElement(By.cssSelector(".pagination li.active a")).getText()), activePage);
		}
	}
